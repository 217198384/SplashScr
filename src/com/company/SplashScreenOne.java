...
public class SplashScreenOne {
    JFrame frame;//Creating object of JFrame
   JLabel image=new JLabel(new ImageIcon("C:\\Users\\pc\\Downloads\\SplashScr\\book.jpeg"));

    JLabel text=new JLabel("Emergency Alert System");
    JProgressBar progressBar=new JProgressBar();
    JLabel message=new JLabel();
    SplashScreenOne()//Creating constructor of the class
    {
        createGUI();
        addImage();
        addText();
    ...
    public void createGUI(){
        ...
        frame.getContentPane().setBackground(Color.magenta);//setting background color
